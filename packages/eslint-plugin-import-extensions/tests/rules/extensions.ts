...
import { extensionsRule } from '../../src/rules/extensions.js'
import { ExtensionMessageIds } from '../../src/rules/extensions.messages.js'

console.log(JSON.stringify(extensionsRule, undefined, 2))
